...
\item[A:] Nesmírně! Nikdy před tím jsem v čínské restauraci nejedl, ale
    ...
    si popovídat a posedět, nebo někam spěcháte? Jen se mi to zdálo, nebo skutečne mluvíte slovensky?
...
\item[Ž:] S radosťou sa s vami pozhováram, kým dopijeme čaj. Čašník!\\
    ...
    A nie, milý Achilles, naozaj dnes hovorím po slovensky.
    
\item[A:] A proč to?

\item[Ž:] Počul som, že je to krajší jazyk ako čeština, tak som si ho chcel vyskúšať.

\item[A:] Zajímavé. Možná toho víte více než já o jazycích a čínské kuchyni, ale vsadím
...
\item[A:] Nepřeháníte to s tým slovenským experimentem trochu? Předpokládám, že po 
    vhození si to přehrávač B1 přihasil po koleji
    a začal rotovat?
...
\item[Ž:] Samozrejme, znie to celkom rozumne\dots Samozrejme len za predpokladu, 
